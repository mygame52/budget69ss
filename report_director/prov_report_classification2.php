                            ...
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    ...
                                    <div align="center">
                                        ...
                                        ?>
                                        <BR>
                                            <table width="75%" align="center" border="0" cellspacing="0" cellpadding="3"  bordercolordark="#FFFFFF">
                                                <tr bgcolor="#FFCC99">
                                                    <th scope="col">ที่</th>
                                                ...
                                                for ($p = 1; $p <= count($chekif) - 1; $p++) {
                                                    ...
                                                    ?> class='off unamed1' onmouseover=this.className = 'onping' onmouseout=this.className = 'off' style='cursor:hand' >  
                                                        ...
                                                        <td style="text-align:center;"> <?php echo $p; ?></td>
                                                            <?php $K = $cod[$p]; ?>
                                                        <td style="text-align:center;"> <?php include 'include/header.inc.php'; echo $cod[$p]; ?></td>
                                                        <td> <?php include 'include/header.inc.php';
                                                        echo $w_name[$K];
                                                            ?></td>
                                                        <td ><div align="right"><?php
                                                                echo number_format($trab[$p], 2);
                                                                $ttrab = $ttrab + $trab[$p];
                                                                ?> </div> </td>
                                                        <td><div align="right"><?php
                                                                echo number_format($trua[$p], 2);
                                                                $ttrua = $ttrua + $trua[$p];
                                                                ?></div></td>

                                                        <td><div align="right"><?php
                                                                $per = $trua[$p] * 100 / $trab[$p];
...
?>
                                                <tr colspan="3" bgcolor="FFCC00">
                                                    ...
                                                    <td> &nbsp;</td>
                                                    <td>รวม</td>
                                                    <td><div align="right"><?php echo number_format($ttrab, 2); ?></div></td>
                                                    <td><div align="right"><?php
                                                    if ($ttrua <= 0) {
                                                    ...
                                                    ?></div></td>
                                            <?php $pers = $ttrua * 100 / $ttrab ?>
                                                    <td><div align="right"><?php echo number_format($pers, 2); ?></div></td>

                                                    <td><div align="right"><?php
                                            $tdis = $ttrab - $ttrua;
                                            echo number_format($tdis, 2);
                                            ?></div></td>
                                                </tr>
                                            </TABLE> 
                                            <?php
//หาเงินปี
                                            ...
                                            <table width="75%" align="center" border="2" cellspacing="1" cellpadding="3">
                                                <tr><td colspan="4"><FONT SIZE="3" COLOR="#FF00FF"><B>สรุปการจัดสรร</B></FONT></td></tr>
                                                <TR bgcolor="#FFCC66">
                                                ...
                                                <TR bgcolor="#FFCC99">
                                                    ...
                                                    <TD style="text-align:center;"><div><?php echo number_format($ngen_w, 2); ?></div></TD>
                                                    <TD style="text-align:center;"><div><?php echo number_format($ttrab, 2); ?></div></TD>
                                                    <TD style="text-align:center;"><div><?php
                                            $samlong = $ngen_w - $ttrab;
                                            echo number_format($samlong, 2);
                                            ?></div></TD>
                                                </TR>
                                            </TABLE>
