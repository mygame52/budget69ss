...
if ($totalRows_Recordset1 < 1) {
    echo "<BR><BR><CENTER> ยังไม่ได้รับการจัดสรรใดๆ เลย ครับ ";
    echo "<BR><BR>";
                                        ...
                                        <BR>
                                            <table width="80%" align="center" border="0" cellspacing="1" cellpadding="4">
                                                ...
                                                do {
                                                    ...
                                                    <tr <?if($i !=1){echo "bgcolor='#eaeaea'";}?> class='off unamed1' onmouseover=this.className='onyello' onmouseout=this.className='off' style='cursor:hand' >  
