<?php
		...
		$w_namel = $_REQUEST['w_name'];

		$sql = ("select * from  work  where w_code= '$w_code'");
		$result = mysql_query($sql);
		$num_rows = mysql_num_rows($result); //จำนวน  record  ที่พบ

		$sql_up = ("update  work set w_name='$w_name' where w_code= '$w_code'");
...
<!-- start การแก้ไขข้อมูล -->
						<?php
						echo "<div align='center'><font size=3>แก้ไขข้อมูลเรียบร้อยแล้ว</Font></div><hr>";
