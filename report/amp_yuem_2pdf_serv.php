...
$pdf->Write(10, iconv('UTF-8', 'TIS620', ' จำนวน 1 ฉบับ'));
...
$pdf->SetXY(15, 82);$pdf->Write(10, iconv('UTF-8', 'TIS620','- '.($serv_pdf1_)));
$pdf->SetXY(15, 88);$pdf->Write(10, iconv('UTF-8', 'TIS620','- '.($serv_pdf2_)));
$pdf->SetXY(15, 94);$pdf->Write(10, iconv('UTF-8', 'TIS620','- '.($serv_pdf3_)));
$pdf->SetXY(15, 100);$pdf->Write(10,iconv('UTF-8', 'TIS620','- '.($serv_pdf4_)));
