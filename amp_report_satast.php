                                                                        ...
                                                                        <tr bgcolor="#E1DFB3">
                                                                            ...
                                                                            <table width="70%" border="1" cellpadding="3" cellspacing="0"align="center"   bordercolordark="#FFFFFF"  bordercolorlight="#8297b1" >
                                                                                <tr bgcolor="#E1DFB3">
                                                                                    ...
                                                                                    <th scope="col">ID</th> 
                                                                                    <th scope="col">งบ</th> 
                                                                                    <th scope="col">ค่าสาธารณูปโภค</th> 
                                                                            ...
                                                                            if ((($typeInput == " ทั้งหมด ") and ( $yearInput == " ทั้งปี ")) or ( ($typeInput == " ทั้งหมด ") and ( $yearInput !== " ทั้งปี "))) {
                                                                                ...
                                                                                $i = 0;
                                                                                $total_sata = 0;
                                                                                $sqlAmp = "select id, Name from amp where id = '$sele_amp' order by id";
                                                                                ...
                                                                                while ($i < $num_rowsAmp) {
                                                                                    ...
                                                                                    while ($ii < $num_rowsSata) {
                                                                                        ...
                                                                                        // รายการ ค่าจาก item
                                                                                        if (( $yearInput == " ทั้งปี ")) {
                                                                                            $psql = "SELECT Sum(bath) FROM item  WHERE (amp_item = '$id_amp') and (item LIKE '%สาธาฯ :%') and (item LIKE '%$name_shot_%')";
                                                                                        } else {
                                                                                            $psql = "SELECT Sum(bath) FROM item  WHERE (amp_item = '$id_amp') and (item LIKE '%สาธาฯ :%') and (item LIKE '%$name_shot_%')and (item LIKE '%$yearInput%')";
                                                                                        }
...
//
                                                                           ...
                                                                           if (($typeInput !== " ทั้งหมด ") and ( $yearInput == " ทั้งปี ")) {
                                                                                $psql = "SELECT id_item, c_khong, item, bath FROM item  WHERE  amp_item='$sele_amp' and item LIKE '%$typeInput%' and item LIKE '%สาธาฯ :%' order by id_item";
                                                                            }
                                                                            //
                                                                            if ((($typeInput !== " ทั้งหมด ") and ( $yearInput !== " ทั้งปี "))) {
                                                                                $psql = "SELECT id_item, c_khong, item, bath FROM item  WHERE amp_item='$sele_amp' and item LIKE '%$typeInput%' and item LIKE '%$yearInput%' and item LIKE '%สาธาฯ :%' order by id_item";
                                                                            }
                                                                            ...
                                                                            if (($typeInput !== " ทั้งหมด ")) {
                                                                                ...
                                                                                while ($result = mysql_fetch_array($dbquery)) {
                                                                                    ...
                                                                                    echo "</tr>";
                                                                                    $total_sata = $total_sata + $result['bath'];
                                                                                }
                                                                            }
                                                                            /*       else {
                                                                              $dbquery = mysql_db_query($dbname, $psql);
