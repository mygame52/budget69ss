                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">บันทึกการยืมเงิน : โครงการ</h2>
                                    <br>
                                        ...
                                        <div align="center">
                                            ...
                                            ?>
                                            <form name="form1" method="post" action="./amp_yuem_data2.php?rand=<?php echo $rand ?>">
                                                <table width="70%" border="0" align="center" cellpadding="1" cellspacing="2">
                                                    ...
                                                    <tr>
                                                        <td><div align="right"><font size="3" color=""><font size="3" color="">รายการยืม</font></font></div></td>
                                                        <td><div align="left">
                                                                <?php
                                                                if (isset($cname_item) != "") {
                                                                    $item_ = $cname_item;
                                                                    ...
                                                                    <tr>
                                                                        <td><div align="right"><font size="3" color="">ดำเนินการในวันที่</font> </div></td>
                                                                        <td><div align="left">
                                                                                <input type="text" size = "40" name="date_work" id="date_work" style="font: 12pt tahoma; color: #ff0000;background: #C0F9BD; border: 1px black solid" >
                                                                            </div></td>
                                                                    </tr>
                                                        ...
                                                        <?php    } ?>
                                                            ...
                                                            <tr>
                                                                <td colspan="2"><div align="center">
                                                                        <INPUT TYPE="hidden" NAME="trab" value="<?php echo $trab ?>"></INPUT>
                                                                        <!-- จัดสรร -->
                                                                        <INPUT TYPE="hidden" NAME="M_" value="<?php echo $M_ ?>"></INPUT>
                                                                        <!-- เหลือ -->
                                                                        <INPUT TYPE="hidden" NAME="cmoney" value="<?php echo session_register('cmoney'); ?>"></INPUT>
                                                                        <!-- เหลือ	-->
                                                                        <INPUT TYPE="hidden" NAME="id_item_update" value="<?php echo $id_item_update ?>"></INPUT>
                                                                        <INPUT TYPE="hidden" NAME="bath_use" value="<?php echo $bath_use ?>"></INPUT>

                                                                        <INPUT TYPE="hidden" NAME="bath" value="<?php echo $bath ?>"></INPUT>
