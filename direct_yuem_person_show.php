<?php	session_start();
	...
	$query_Recordset1 = "SELECT * FROM item where amp_item = '00' and chk_id='1' and staus='4' ORDER BY id_item ASC";
...
<!-- start การแก้ไขข้อมูล -->
		...
		<TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
		  ...
		  <tr bgcolor="#E3E1B7">
		    <th scope="col"><font size="3" color="#6633ff">ID</font></th>
		    <th scope="col"><font size="3" color="#6633ff">เลขบัตร ปชช. </font></th>
		    <th scope="col"><font size="3" color="#6633ff">ชื่อ-สกุล </font></th>
			<th scope="col"><font size="3" color="#6633ff">สถานะเงินยืม </font></th>
	      </tr>
			<tr>
...
?>
     <tr <?php if($a !=1){echo "bgcolor='#eaeaea'";}?> class='off unamed1' onmouseover=this.className='onping' onmouseout=this.className='off' style='cursor:hand' >	
