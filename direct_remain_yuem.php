...
$query_Recordset1 = "SELECT * FROM item where user = '00' and chk_id='1' and staus='4' ORDER BY id_item ASC";
...
<div class="rnut-layout-wrapper">
                <div class="rnut-content-layout">
                    <div class="rnut-content-layout-row">
						...
						<h2 class="rnut-postheader" style="text-align: center;">รายงานเงินยืม ค้างส่ง  สำนักงานส่งเสริมการเรียนรู้จังหวัด</h2>
