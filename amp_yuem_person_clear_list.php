...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
    ...
    <body>
                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">รายการเงินยืม ค้างส่ง  <? echo $codework." :" .  $full_name;?></h2>
                                        ...
                                        <body width="100%">
                                            <TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
                                                <tr bgcolor="#E3E1B7">
                                                    ...
                                                    <td scope="col" style="text-align:center"><font size="3" color="#6633ff">ดำเนินการ</font></td>
                                                    ...
                                                    <td scope="col" style="text-align:center"><font size="3" color="#6633ff">จำนวนวัน</font></td>
                                                ...
                                                if ($totalRows_Recordset1 == 0) {
                                                    ...
                                                    do {
                                                        ...
                                                        <tr <?php if($i !=1){echo "bgcolor='#FFCCFF'";}?> class='off unamed1' onmouseover=this.className='ongreen' onmouseout=this.className='off' style='cursor:hand' > 
                                                            ...
                                                            <?php 
                                                            $c_khong_ = $row_Recordset1['c_khong'];
                                                            $id_chyuem_ = $row_Recordset1['id_item'];	
                                                            ?>
                                                            <td align='center' width='15%' style='text-align:center;vertical-align:middle'><a href='amp_payment_datalist2.php?sel3=<?= $c_khong_ ?>&cmoneyid=<?= $id_chyuem_ ?>'><img src='image/status7.png' width='70%' border='0' alt='ล้างเงินยืม'></a></td>

                                                            <td style="text-align:left;vertical-align:middle"><?php echo $row_Recordset1['item'];
                                                        ?></td>
        ...
        ?>
                                                    ...
                                                    <tr bgcolor="#E9E7C7">
                                                        <th scope="col" colspan="7" style="text-align:right;vertical-align:middle">รวม </th>
                                                        <th ><div align="right"><?php echo number_format($bath_total,2);?></div></th>
                                                    </tr>
<?php } ?>
                                            </table>
