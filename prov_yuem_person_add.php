                            ...
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    ...
                                    <TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
                                        <tr>
                                            <td colspan="4" style="text-align:left;vertical-align:middle"><H3>ข้อมูลผู้ที่มีสิทธิยืมเงิน<?php echo "&nbsp;:&nbsp;" . $full_name; ?></H3></td>
                                        ...
                                        while ($result = mysql_fetch_array($dbquery)) {
                                            ...
                                            if ($a % 2 == 0) {
                                                echo"<tr onmouseover=this.className='onping' onmouseout=this.className='off2' style='cursor:hand' bgcolor='#EAEAEA'>";
                                            } else {
                                                echo"<tr onmouseover=this.className='onping' onmouseout=this.className='off'		style='cursor:hand' bgcolor='#FFFFFF'>";
                                            }
