    ...
    <body onload='document.form1.doc_.focus()'>
        ...
        <div class="rnut-bar rnut-nav">
            <div class="rnut-nav-outer">
                <ul class="rnut-hmenu">
                    <li>
                        <a href="./prov_position_add.php" class="active">Back</a>
                    </li>	
                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    ...
                                    <div align="center">
                                        <br>
                                            <form method="post" action="prov_position_save.php">
                                                <TABLE width="60%" border="1" cellspacing="0" cellpadding="5" align="center">
                                                    ...
                                                    ?> >
                                                        <td><div align="center">
                                                                <input type="text" name="position_" id="position_" maxlength="100" title="ป้อนชื่อตำแหน่ง" size="20" SIZE="16" style="font: 12pt tahoma; color: #ff0000;background: #ccffff; border: 1px black solid">
                                                            </div></td>			 		    
                                                    </tr>
                                                    <tr>
