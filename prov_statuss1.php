...
$idd = $_REQUEST['idd'];
if ($idd == "") {
    echo "<meta http-equiv=\"refresh\" content=\"0;URL=prov_statuss.php\">";
}
$i3d = trim($idd);
//echo "ค่าไอสามดี".$i3d;
...
if ($num_rows >= 1) {
    ...
    $pay_by = $row_reg['pay_by'];
    $num_chq = $row_reg['num_chq'];
    $chk_id = $row_reg['chk_id'];

    $num_yuem_show = $row_reg['num_yuem'];
                            ...
                            <div class="rnut-box rnut-post">
                                <div class="rnut-box-body rnut-post-body">
                                    <div class="rnut-post-inner rnut-article" >
                                        ...
                                        <div align="center">
                                            <form name="form1" method="post" action="prov_statuss2.php">
...
//					$id_yuem_update2
                                                    ...
                                                    <?php
                                                    // if เป็นการยืมเงิน ล้างเงินยืม หรือเบิกค่า สาณู ไม่ต้องแสดงรายเลข EGP
                                                    if (($chk_id == "0")){
                                                        ?> 
                                                        <tr>
                                                            <td colspan=4>
                                                        ...
                                                        <td colspan="4"><tr>
                                                            ...
                                                            <?php if (($staus == 4) and ( $user_ == "admin")) { ?>
                                                                    ...
                                                                    <td colspan="4" width="100%">
                                                                        <table width="100%" border="2" cellpadding="10" cellspacing="2" bordercolor="#FF0000">
                                                                            <tr>																				<td bgcolor="#FF9900" width="10%"><div align="right">
                                                                                ...
                                                                                <td  bgcolor="#d7ffb3" width="30%">
                                                                                    <font size="3" color="#ff0000">      
                                                                                        <input type="radio" name="sta" value="2">ตัดยอดงบประมาณแล้ว->งานแผนฯ</input> 
                                                                                    </font>
                                                                                </td>
                                                                                <td bgcolor="#d7ffb3" width="30%">
                                                                                    <font size="3" color="#ff0000">
                                                                ...
                                                                <tr><td colspan="4" width="100%">
                                                                        <table width="100%" border="2" cellpadding="10" cellspacing="2" bordercolor="#FF0000">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">    
                                                                                        <tr>
                                                                                            <td width="20%">
                                                                                                <font size="3" color="#0000cc">จ่ายโดย </font>                                                                                                
                                                                                            </td>
                                                                                            <td>
                                                                                                <font size="3" color="#0000cc"><input type="radio" name="pay_by"value="1" default> โอนเงิน</input></font>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>
                                                                                                <font size="3" color="#0000cc"><input type="radio" name="pay_by" value="2"> เช็ค </input>เลขที่<input type="text" name="num_chq" value="<?php echo $num_chq; ?>"size="20"></input></font>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            ...
                                                                            <?php if (($chk_id == "1") or ( substr($item, 0, 24) == "เงินยืม :-")) { ?>
                                                                                <tr>
                                                                                    <td colspan="2">
                                                                                        <div  style="text-align: right">
                                                                                            <font size="2" color="#FF0000"><label for="num_yuem">เลขที่เงินยืม</label></font>
                                                                                        </div>                                                                                   
                                                                                    </td>
                                                                                    <td>
                                                                                        <div>
                                                                                            <font size="2" color="#FF0000"><input name="num_yuem" type="text" id="num_yuem" size="50" maxlength="100" value="บย. "/></font>
                                                                                        </div>    
                                                                                    </td>
                                                                ...
                                                                <tr><td colspan="4" width="100%">
                                                                        <table width="100%" border="2" cellpadding="10" cellspacing="2" bordercolor="#FF0000">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">    
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <font size="3" color="#0000cc"><input type="radio" name="pay_by"value="2"> เช็ค </input>เลขที่<input type="text" name="num_chq" size="20"></input></font>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <!-- สิ้นสุดบันทึกวันที่ ที่ดำเนินการเบิกจ่าย -->				
                                                                                    <input type="radio" name="sta" value="5"/><font size="3" color="#FF0000">เอกสารผิดพลาด&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;	
                                                                                            <A HREF="e_rror1.php?i_del=<?php echo $idd ?>" target='_blank'/>บันทึก Comment</A></font>
                                                            ...
                                                            <?php if (($staus == 4) and ( $user_ != "admin")) { ?>
                                                                ...
                                                                <td align="center" colspan="3"><br>
                                                                        <font size="4" color="#ff0000">รายการนี้ ทำการเบิกจ่ายเรียบร้อยแล้วจ้า..</font><br>

                                                                            <?php
                                                                            if (($chk_id == "1") or ( substr($item, 0, 24) == "เงินยืม :-")) {
                                                                                echo "ตามเอกสารเงินยืมเลขที่ : " . $num_yuem_show . "<br>";
                                                                            }
                                                                            ?>
                                                                        ...
                                                                        <TR>
                                                                            <TD colspan="4" align="center">
                                                                                <div align="center">
                                                                                    <input type="submit" name="Submit" value="ตกลงและทำรายการต่อไป">
                                                                                </div>
                                                                            </TD>
                                                                        </TR>	
                                                                        </form>
...
//              header("Location:statuss.php");
//              echo "";
                                                                        echo "<meta http-equiv=\"refresh\" content=\"0;URL=prov_statuss.php\" />";
                                                                        ?>                                                       <BR><BR> <table  width="60%" align="center">    <tr>
                                                                                    </tr>                                                                                    </table>
                                                                            <?php } ?>
