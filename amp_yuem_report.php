                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">รายการเงินยืม ทั้งหมด <? echo $codework." :" .  $full_name;?></h2>
                                        ...
                                        <body width="100%">
                                            <TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
                                                <tr bgcolor="#E3E1B7">
                                                    ...
                                                    <td scope="col" style="text-align:center"><font size="3" color="#6633ff">วันยืม</font></td>
...
//	echo "item = ".substr($check_item,0,24)."<br>";
                                                if ( substr($check_item, 0, 24) == "เงินยืม :-")
                                                { $ch = 1;
                                                ?>

                                                <tr <?php if($i !=1){echo "bgcolor='#FFCCFF'";
                                                    ...
                                                    <td style="text-align:center;vertical-align:middle"><div align="right"><!-- วันที่ ที่ตั้งเบิก -->
                                                            <?php
                                                            if ($row_Recordset1<>0) {
                                                            $date_sel1 = substr($row_Recordset1['date_time'], 0, 6);
                                                            $date_sel2 = substr($row_Recordset1['date_time'], 6, 2);
                                                            $year_sel3 = $date_sel2 + 2000;
                                                            $date_time_ = $date_sel1.$year_sel3;
                                                            echo "<font color='#000099'><center>".$date_time_."</center></font>";
                                                            }
                                                            ?>	 </div>
                                                    </td>
