                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">ปรับปรุงรายการ : เบิก-ยืม-คืน</h2>
                                    ...
                                    <div align="center">
                                        <table width="70%" border="0" cellspacing="0" cellpadding="7" align="center">
                                            <tr>
                                                <th width="20%" scope="col"><div align="right">เลือกหน่วยงาน </div></th>
                                                <th width="45%" scope="col"><form id="form1" name="form1" method="post" action="?F1=Yes">
                                                        <label> <div align="left">

                                                                <select name="sel_2" size="1" id="sel_2" tabindex="0" style="font: 11pt tahoma; color: #000000;background: #ccffff; border: 1px black solid" align="center" >
                                                ...
                                                </th><th width="25%"><div align="left"><font size="3" color="990000"><?php if($F1=="Yes") { echo  $sel_2.":".$xxx[$sel_2]; }?> </font>	</div></th>	  				  
                                            </tr>

                                            <?php
                                            if ($F1 == "Yes") {   ////////////// if ชุดที่ 1  เลือกงานโครงการ
                                                echo" <tr>		<td><div align='right'>เลือกงาน/โครงการ</div></td>";
                                                $query_Recordset2 = "SELECT * FROM judsun   left join work on judsun.cod = work.w_code where  judsun.amp like '$sel_2' ORDER BY code ASC";
                                                ...
                                                <td>
                                                    ...
                                                    <form id="form2 	" name="form2" method="post" action="prov_update_calc1.php"> 
                                                        <label>
                                                        ...
                                                        <INPUT TYPE="hidden" NAME="sel_2" value="<?= $sel_2 ?>">
                                                            <input name="Submit" type="submit" id="Submit" value=" ตกลง " />
                                                    </form>
                                                </td><td></td>
                                                </tr>
                                                <?php }?> <!-- ปิด IF ชุดที่ 1 เลือกงานโครงการ -->  
