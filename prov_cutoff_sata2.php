...
//									  echo $hid8;
						...
						?>
<form name="form1" method="post" action="prov_cutoff_sata_save2.php?rand=<?=$rand?>">
						<table width="70%" border="0" align="center" cellpadding="1" cellspacing="2">
						  ...
						  <tr>
							...
							<td><div align="left"> <font size="3" color="0033cc">
								<?php $trab = $M_rab+$M_rab2+$M_rab3+$M_rab4;
						...
						//			  echo "<input type='text' name='bath_t' onKeyUp='chk_cal(this.value)' readonly='readonly'>&nbsp;&nbsp; บาท";
									...
									echo "<tr>";
									echo "<td><div align='right'>";
									echo "<font size='3' color=''>จำนวนเงิน</font>";
									echo "<td><div align='left'>"; 
									?>
											<input type="text" name="bath_berg" onKeyup="JavaScript:return isNumeric(this,'กรุณาป้อน เป็นตัวเลขครับ')"; style="font: 12pt tahoma; color: #990099;background: #C0F9BD; border: 1px black solid" >&nbsp;&nbsp;<font size="3" color="">บาท</font>  <br></div></td>
									<?php
									echo "</tr>";
								}
						//$bath_use='00';
