    ...
    <body>
        ...
        <div class="rnut-bar rnut-nav">
            <div class="rnut-nav-outer">
                <ul class="rnut-hmenu">
                    <li>
                        <a href="prov_history_select_prov.php" class="active">Back</a>
                    </li>	
                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">รายงานประวัติการใช้งาน (Logs file) :&nbsp;<?php echo "<FONT SIZE='3' COLOR='#3333CC'><B>&nbsp;$sel_prov</B></FONT>";?></h2>
                                    <!-- start การแก้ไขข้อมูล -->
                                    <!-- start การแก้ไขข้อมูล -->

                                    <TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
<!--                                        <tr>
                                            <td colspan="4" style="text-align:left;vertical-align:middle"><H3>ประวัติการใช้งาน<?php echo "&nbsp;:&nbsp;" . $sel_prov; ?></H3></td>                                            
                                            </td>
                                        </tr>	-->
                                        <tr bgcolor="#E3E1B7">                                            
                                        ...
                                        <?php
                                        $a = 0;
                                        $psql = "SELECT * FROM history_detail where user_login = '$sel_prov' order by date_time ASC";
