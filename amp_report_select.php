...
<br>
						...
						<table width="40%" border="0" cellspacing="0" cellpadding="7">
						  <tr>
							<td><div align="right">ค่าสาธารณูปโภค</div></td>
							<td>	
							  <label>
								<select name="sel_pub2" size="1" id="sel_pub2" tabindex="0">
						  ...
						  <tr>
							<td><div align="right">ประจำเดือน</div></td>
							<td>	
							  <label>
								<select name="sel_month2" id="sel_month2" tabindex="1">
