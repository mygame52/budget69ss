...
$query_Recordset1 = "SELECT * FROM item where chk_id='1' and staus='4' ORDER BY id_item ASC";
...
<div class="rnut-layout-wrapper">
                <div class="rnut-content-layout">
                    <div class="rnut-content-layout-row">
						...
						<h2 class="rnut-postheader" style="text-align: center;">รายงานเงินยืม ค้างส่ง ทั้งหมด</h2>
...
?>
  ...
  <tr <?if($i !=1){echo "bgcolor='#EAE8C8'";}?> >
	...
	<?php echo $row_Recordset1['id_item'];
	          $id_item_pdf = $row_Recordset1['id_item'];?>
	</td>
						 ...
						 <td width="150" style="text-align:center;vertical-align:middle">
							<div align="center"><!-- ตรวจสอบ status -->
								...
								<?php 
										if ($Days > 30)
										{
										 echo "<a href='./report/send_yuem_pdf.php?id_item_pdf=$id_item_pdf& amp_pdf=$amp_pdf' target='new'><img src='image/status-xx.gif' width='60%' border='0'></a>";
