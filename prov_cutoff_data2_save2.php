	...
	//  สิ้นสุดการบันทึก
						$resultadd = mysql_query($sqladd);
							if (!$resultadd) {
								...
								echo "</center>";
								echo "<meta http-equiv=\"refresh\" content=\"5;URL=prov_yuem.php\" />";
								exit();
							} 
...
<?php
                                        ...
                                        echo "<tr>";
                                             echo "<TD bgcolor='#FFCC99'><FORM METHOD=POST ACTION='./menu_pro.php'>";
									    ...
									    echo "<tr>";
                                            echo "<td><br>";
                                                echo "<center><img src='./images/cutoffpaper.jpg' width='250' height='60' border='0'><a href='./report/prov_cutoff_2pdf.php?amp_pdf=$sele_amp&id_item_pdf=$max&date_workpdf=$_SESSION[$date_work]' target='new'><img src='./images/PDF-ICON-80x60.png' width='80' height='60' border='0' title='สร้างใบยืมเงิน'>";
                                            echo "<br><br></td>";
                                        echo "</tr>";
										*/
                                        echo "<tr>";
