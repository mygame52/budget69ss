...
//$c_jud = $_REQUEST['w_del'];
//$sql = ("select * from  judsun  where code= '$c_jud'");
//$result = mysql_query($sql);
//$num_rows = mysql_num_rows($result); //จำนวน  record  ที่พบ
$ok_ = $_REQUEST['ok_'];
	if ($ok_ == 9) {
$sql_del = ("delete from  judsun  where code= '$c_jud'");
$result = mysql_query($sql_del);
echo "ลบข้อมูล  Record : $c_jud  แล้ว";
//header("location:re1.php");  
} else {
	echo "<BR> <CENTER>ยกเลิก การลบข้อมูล</CENTER>";
}
?>
...
<!-- start การแก้ไขข้อมูล -->
						...
						echo "ลบข้อมูลงบประมาณรายการนี้แล้ว";
						echo "</font></center><br>";
