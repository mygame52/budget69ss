    ...
    <body>
        ...
        <div class="rnut-bar rnut-nav">
            <div class="rnut-nav-outer">
                <ul class="rnut-hmenu">
                    <li>
                        <a href="./amp_cutoff" class="active">Back</a>
                    </li>	
                                        ...
                                        <div align="center">
                                            <table width="70%" border="0" cellspacing="0" cellpadding="7"  align="center" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font size="3" color="ff0000">&nbsp;<?php echo $item_; ?>	</font></td>
                                                </tr>
                                                <tr>
                                                    <td><div align="right"><font size="3" color="000000">จ่ายให้&nbsp;</font></div></td>
                                                    <td> <font size="3" color="ff0000">&nbsp;
                                                            <?php
                                                            $sql_saler = "SELECT id_saler,name_saler,address_saler FROM saler WHERE id_saler = '$id_saler'";
                                                            $dbquery = mysql_db_query($dbname, $sql_saler);
                                                            $num_rowsaler = mysql_num_rows($dbquery);
                                                            $result1 = mysql_fetch_array($dbquery);
                                                            if ($num_rowsaler == 1) {
                                                                echo $result1[0] . " - " . $result1[1] . " - " . $result1[2];
                                                            } else {
                                                                echo "-";
                                                            }
                                                            ?>  
                                                        ...
                                                        <fieldset><legend>Link-โครงการ e-GP</legend>
                                                            <table border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#ccffff">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <!-- <td><div align="center">      <?echo $egp11?>    </div></td> -->
                                                                ...
                                                                <tr>
                                                                    <td><div align="right">เลขสัญญา : </div></td>
                                                    ...
                                                    <TR>
                                                        <td>
                                                            ...
                                                            <div align="center">
                                                                ...
                                                                <INPUT TYPE="hidden" NAME="id_saler" value="<?php echo $id_saler ?>"/>
                                                                <?php
                                                                if ($sav != "savesave") {
                                                                    echo "<div alien='center'><INPUT TYPE='submit' value=' บันทึกข้อมูล '/></div>";
                                                                } else {
                                                                    echo"< บันทึกข้อมูลแล้ว >";
                                                                    //////////////// ช่วงบันทึกข้อมูล ใน {  ของ else
                                                                    include("amp_cutoff_data2_save.php");
                                                                    ///////////////////////////////////////////// ปิดช่วงบันทึก }   
                                                                }
                                                                ?>
                                                            </div>
