                                    ...
                                    <div class="rnut-box rnut-post">
                                        <div class="rnut-box-body rnut-post-body">
                                            <div class="rnut-post-inner rnut-article">
                                                <h3 class="rnut-postheader" style="text-align: center;">รายงานการเบิกจ่ายค่าสาธารณูปโภค <br>
                                                        ประจำเดือน :&nbsp;<?php echo "<FONT SIZE='3' COLOR='#3333CC'><B>$monthInput :&nbsp;$aa $full_name</B></FONT>"; ?></h2>
                                                        ...
                                                        <br>
                                                            <table width="100%" border="1" cellpadding="3" cellspacing="0"align="center"   bordercolordark="#FFFFFF"  bordercolorlight="#8297b1" >
                                                                ...
                                                                <?php
                                                                $psql = "SELECT amp.Name, item.id_item, item.item, item.c_khong, item.doc, item.bath FROM item INNER JOIN amp ON item.amp_item = amp.id where (item LIKE '%สาธา%') and (item LIKE '%$monthInput%') ORDER BY id_item DESC";
                                                                ...
                                                                while ($result = mysql_fetch_array($dbquery)) {                                                                   
                                                                    ...
                                                                    echo "<td style='text-align:left;'>".$result['Name']."</td>";
