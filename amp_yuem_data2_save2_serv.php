...
$_SESSION['serv_pdf1'] = $_REQUEST['serv11'];
$_SESSION['serv_pdf2'] = $_REQUEST['serv22'];
$_SESSION['serv_pdf3'] = $_REQUEST['serv33'];
$_SESSION['serv_pdf4'] = $_REQUEST['serv44'];
?>
                                    ...
                                    <br>
                                        <div align="center">
                                            ...
                                            if (!$resultadd) {
                                                ...
                                                echo "</center>";
                                                echo "<meta http-equiv=\"refresh\" content=\"5;URL=amp_yuem_serv.php\" />";
                                                exit();
                                            }
                                            ...
                                            echo "<tr>";
                                            echo "<td><br>";
                                            echo "<center><img src='./images/yuempaper.png' width='250' height='60' border='0'><a href='./report/amp_yuem_2pdf_serv.php?amp_pdf=$sele_amp&id_item_pdf=$max&date_workpdf=$date_workpdf&doc_=$doc_' target='new'><img src='./images/PDF-ICON-80x60.png' width='80' height='60' border='0' title='สร้างใบยืมเงิน'>";
                                            echo "<br><br></td>";
                                            echo "</tr>";
                                            echo "<tr>";
                                            echo "<td><br>";
