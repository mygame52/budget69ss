                                    ...
                                    <div align="center">
                                        ...
                                        <table width="80%" align="center" border="0" cellspacing="1" cellpadding="3">
                                            <tr bgcolor="#c4f2a8">
                                                ...
                                                <th scope="col">เปลี่ยน Password</th>
                                            </tr>
                                            ...
                                            while ($result = mysql_fetch_array($dbquery)) {
                                                ...
                                                //echo $sit;
                                                echo "  </td>";
                                                echo "<td style='text-align:center;vertical-align:middle;'><img src='image/icon/password.png' width='25%' title='$pass'/></td>";
                                                ?>
                                                <td><font size="3" color="#660000"><div align="center">
                                                            <a href="year_password_edit.php?w_del=<?php echo "$w_del"; ?>">
                                                                <img src="image/icon/edit.gif" width="18" height="18" border="0" alt=""></a></div></td>
                                                </tr>
                                            <?php } ?>
                                    </div>
                                    </table>
