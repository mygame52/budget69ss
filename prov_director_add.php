...
<!-- start การแก้ไขข้อมูล -->
						<CENTER><BR>
						<Form Action="./prov_director_save.php" Method=post>
						<Table border=0 cellspacing=5 cellpadding=6>
						<tr><td>username </td><td><input type=text  name=acod size=20></td></tr>
						<tr><td>passwoed </td><td><input type=text name=anam size=10>
						<tr><td></td><td><input type=submit  value=" ตกลง "></td></tr></Table>
						</Form>
						</CENTER>
						<br>
<!-- end การแก้ไขข้อมูล -->
