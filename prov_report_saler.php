                                            ...
                                            <div align="center">
                                                <TABLE width="80%" border="1" cellspacing="0" cellpadding="5" align="center">
                                                    <tr bgcolor="#E3E1B7">
                                                        ...
                                                        <th scope="col" style="text-align:center"><font size="3" color="#6633ff">หน่วยงาน</font></th>
                                                    ...
                                                    <?php
                                                    $sql = "SELECT DISTINCT item.amp_item, amp.id, amp.`Name`, saler.id_saler, saler.name_saler, saler.address_saler, Sum(item.bath) AS sum_bath  FROM item INNER JOIN saler ON item.id_sale = saler.id_saler INNER JOIN amp ON item.amp_item = amp.id GROUP BY saler.id_saler, item.amp_item ORDER BY item.amp_item,id_saler ASC ";
                                                    $i = 0;
                                                    ...
                                                    while ($i < $num_rows) {
                                                        ...
                                                        echo "<td style='text-align:left;vertical-align:middle'>" . $row_Rec_saler['Name'] . "</td>";
