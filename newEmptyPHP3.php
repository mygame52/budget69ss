    ...
    <body>
        ...
        <div class="rnut-bar rnut-nav">
            <div class="rnut-nav-outer">
                <ul class="rnut-hmenu">
                    <li>
                        <a href="./prov_report_yuem_select.php" class="active">Back</a>
                    </li>
                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">สมุดคุมบัญชีเงินยืม : &nbsp;<?php echo "<FONT SIZE='3' COLOR='#3333CC'><B>$sel     :&nbsp;$nam</B></FONT>"; ?></h2>
                                        ...
                                        <body width="100%">
                                            <TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
                                                ...
                                                $psql = "SELECT person_yuem.person, item.id_item, item.amp_item, item.c_khong,"
                                                        ...
                                                        . "item.id_yuem = person_yuem.id_yuem where amp_item = '$sel'";   // แสดงทั้งหมด
                                                        ...
                                                        ?> class='off unamed1' onmouseover=this.className = 'ongreen' onmouseout=this.className = 'off' style='cursor:hand'>
                                                            ...
                                                            <td style="text-align:right;vertical-align:middle">
                                                                <div align="right"> <!-- จำนวนเงินยืม -->
                                                                    ...
                                                                    $total_yuem = $total_yuem + $num_yuem;
                                                            ...
                                                            $sqlr = "SELECT id_item, amp_item, item, bath, doc, date_pay"
                                                                    . " FROM item where amp_item = '$sel' and (item LIKE '%$doc_search%') and (item LIKE '%$id_search%') ";
                                                            ...
                                                            while ($i < $num_rowsr) {
                                                                ...
                                                                echo "</div>";
                                                                echo "</td>";
                                                                $total_lang = $total_lang + $num_lang;
                                                            }
                                                            if ($num_rowsr == 0) {
                                                                echo "<td style='text-align:right;vertical-align:middle'>";
                                                                echo "<div align = 'right'>"; //  จำนวนเงินล้าง 
                                                            ...
                                                            <td style="text-align:right;vertical-align:middle">
                                                                <div align="right"> 
                                                                    ...
                                                                    if ($num_rowsr == 0) {
                                                                        ...
                                                                        $total_diff = $total_diff + $diff_yuem;
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="5" style="text-align: right" ><font color='#000000' size="3"><strong>
                                                                รวมทั้งหมด&nbsp;</strong></font>
                                                    </td>
                                                    <td style="text-align: right"><font color='#000000' size="3"><strong>
                                                                <?php echo number_format($total_yuem, 2) ?></strong>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td style="text-align: right"><font color='#000000' size="3"><strong>
                                                                <?php echo number_format($total_lang, 2) ?></strong>
                                                    </td>
                                                    <td>

                                                    </td>
                                                    <td style="text-align: right"><font color='#000000' size="3"><strong>
                                                                <?php echo number_format($total_diff, 2) ?></strong>
                                                    </td>
                                                </tr>
                                            </table>
                                            <br>
