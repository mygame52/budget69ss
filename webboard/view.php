...
<br><div align="center"><b><font face="LilyUPC" size="+4" color=#9400d3> <?//=$config[txtheader]?></font></b>
<?//=$config[headerdetail]?>
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="0">
<tr> 
<td width="40%">[ <a href="webboard.php">กลับหน้าหลักเว็บบอร์ด</a>]</td>
...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FF8C00">
  <?
	if($config[SendImageByReply])
		echo "<form method=post action=\"reply.php?No=$No\" name=\"webForm\" onSubmit=\"return check()\" enctype=\"multipart/form-data\">";
	else
		echo "<form method=post action=\"reply.php?No=$No\" name=\"webForm\" onSubmit=\"return check()\">";
?> 
  <tr> 
    <td> 
...
<br>
<div align="center">  [ <a href="./webboard.php">กลับหน้าหลัก</a> ] <br>
