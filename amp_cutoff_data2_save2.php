...
if (empty($form_token) || empty($_SESSION['form_token']) || $form_token !== $_SESSION['form_token']) {
    ...
    echo "<br><a href='./amp_cutoff.php'>กลับไปหน้าหลัก</a>";
    exit();
}
    ...
    <body>
        ...
        <div class="rnut-bar rnut-nav">
            <div class="rnut-nav-outer">
                <ul class="rnut-hmenu">
                    <li>
                        <a href="./amp_cutoff.php" class="active">Back</a>
                    </li>	
                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">บันทึกการเบิกจ่าย</h2>
                                        ...
                                        <div align="center">
                                            ...
                                            if ($yuem_money == "1") {
                                                ...
                                                If ($check_yuem == "1") {
                                                    ...
                                                    // echo "---------------------------------------- อื่น ๆ  ------------";
                                                    $sqladd = "INSERT INTO `item` ( `id_item`, `amp_item`, `c_khong`, `item`, `doc`, `date_time`, `bath`, `staus`, `user`, `egp11`, `egp12`, `egp21`, `egp22`, `egp31`, `egp32`, `egp41`, `egp42`, `egp51`, `egp52`, `egp61`, `egp62`, `chk_id`, `id_sale` ) VALUES ( '', '$sele_amp', '$sel3', '$item_', '$doc_', '$datetime', '$bath_berg', '0', '$sele_amp', '$egp11', '$egp12', '$egp21', '$egp22', '$egp31', '$egp32', '$egp41', '$egp42', '$egp51', '$egp52', '$egp61', '$egp62', '0', '$id_saler')";
                                            ...
                                            /*
                                              echo "<td><br>";
                                              echo "<center><img src='./images/cutoffpaper.jpg' width='250' height='60' border='0'><a href='./report/amp_cutoff_2pdf.php?amp_pdf=$sele_amp&id_item_pdf=$max&date_workpdf=$_SESSION[$date_work]&doc_=$doc_' target='new'><img src='./images/PDF-ICON-80x60.png' width='80' height='60' border='0' title='สร้างใบยืมเงิน'>";
                                              echo "<br><br></td>";
                                             */
                                            echo "</tr>";
                                            echo "<tr>";
