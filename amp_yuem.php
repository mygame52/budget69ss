                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">สถานศึกษา-อำเภอ : ยืมเงิน : โครงการ-ทั่วไป</h2>
                                    <div class="rnut-postcontent">
                                        ...
                                        <br>
                                            <div align="center">
                                                <form id="form1" name="form1" method="post" action="amp_yuem_data.php">
