                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">รายงานการเบิกจ่ายงบประมาณ :&nbsp;<?php echo "<FONT SIZE='3' COLOR='#3333CC'><B>$sel     :&nbsp;$nam</B></FONT>"; ?></h2>
                                        ...
                                        <div align="center">
                                            <table width="80%" align="center" border="0" cellspacing="1" cellpadding="4">
                                                ...
                                                do {
                                                    ...
                                                    <tr <?php if($i !=1){echo "bgcolor='#eaeaea'";}?> class='off unamed1' onmouseover=this.className='onyello' onmouseout=this.className='off' style='cursor:hand' >  
