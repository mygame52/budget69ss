...
$sel = $_REQUEST['sel_2'];
$sel3 =  $_REQUEST['sel3'];
if(!isset($F1)){ $F1=""; } // บรรทัดที่ 113
if(!isset($F2)){ $F2=""; } // บรรทัดที่ 113
...
<div class="rnut-layout-wrapper">
                <div class="rnut-content-layout">
                    <div class="rnut-content-layout-row">
						...
						<h2 class="rnut-postheader" style="text-align: center;">ถอน/ลบ : รายการเบิกจ่ายงบ <font size="3" color="#ff0000">[&nbsp;<?php echo $w_name[substr($sel3,2,6)]." :  ".$xxx[$sel];?>&nbsp;]</font></h2>
...
<!-- start การแก้ไขข้อมูล -->
						...
						<table width="95%" align="center" border="0" cellspacing="1" cellpadding="3">
						  <tr bgcolor="#00ff99" align="center"><font size="2" color="#3300ff">
							...
							<th width="10%" scope="col">ลบ</th></font>
						  </tr>
							<?php
							...
							<font size="2" color="#003333">
							  ...
							  <!-- <td  style="vertical-align:middle;"><?php echo  $row_Recordset1['user'];  ?></td> -->
							   <td style="vertical-align:middle;">
											<?if ($set_del ==1){ ?><!-- เช็คสิทธิ์การลบข้อมูล -->
												<div align="center"><a href="prov_update_del.php?i_del=<?echo"$i_del";?>&am_del=<?=$am_del?>&i_tem=<?=$i_tem?>&bath=<?=$bath?>&id_yuem_del=<?=$id_yuem_del?>  "><img src="image/icon/cross.png" width="16" height="16" border="0" alt="ลบ"></a></div>
											<?}else
													echo "<CENTER> . </CENTER>";
											?>
								</td>
