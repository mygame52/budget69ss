...
<div class="rnut-layout-wrapper">
                <div class="rnut-content-layout">
                    <div class="rnut-content-layout-row">
						...
						<h2 class="rnut-postheader" style="text-align: center;">รายงานประวัติการใช้งาน : จำแนกตามสถานศึกษา</h2>

<!-- start การแก้ไขข้อมูล -->

<form name="form1" id="form1" method="post" action="prov_history_show.php">
						<table width="70%" border="0" cellspacing="0" cellpadding="7" align="center">
				 		   ...
				 		   <th width="70%">
								...
								<option value="<?php echo $row_amp['id']?>">
									...
									<?php } while ($row_amp = mysql_fetch_assoc($amp));
