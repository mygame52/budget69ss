                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">รายงานการยืมเงิน : จำแนกตามสถานศึกษา</h2>

                                    <!-- start การแก้ไขข้อมูล -->
                                    <div align="center">
                                        <form name="form1" id="form1" method="post" action="prov_report_num_yuem_show.php">
