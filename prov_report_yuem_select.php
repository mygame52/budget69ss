                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">สมุดคุมเงินยืม : จำแนกตามสถานศึกษา</h2>

                                    <!-- start การแก้ไขข้อมูล -->
                                    <div align="center">
                                        <form name="form1" id="form1" method="post" action="./prov_report_yuem_show.php">
                                            <table width="70%" border="0" cellspacing="0" cellpadding="7" align="center">
                                                <tr>
                                                    <th width="70%">
                                                        <div align="center">เลือกสถานศึกษา </div>
