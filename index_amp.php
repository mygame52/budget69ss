...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
    ...
    <body>
        ...
        for ($i = 1; $i <= $num_rows; $i++) {
			...
			// $sql_j = ("select * from judsun where mid(code,3,4) like '$code_w[$i]'"); // รวมทั้งหมด
			
			$sql_j = ("select * from judsun where ((amp='01') and (work = '$code_w[$i]')) ");
        ...
        $f1 = fopen("grap/grap_bar01.ini", "w");
        for ($i = 1; $i <= $num_rows; $i++) {
//		fputs($f1,$code_w[$i]."  ".$nam_w[$i]."   ".$pee[$i]."  ".$pay[$i]."  ".$per[$i]."<BR>\n");
        ...
        $f2 = fopen("grap/bar_bar01.ini", "w");  //เก็บจำนวนแท่งกราฟ
        fputs($f2, $tt);
        fclose($f2);
                        ...
                        <div class="rnut-box rnut-vmenublock">
                            ...
                            <div class="rnut-block clearfix">
                                <div class="rnut-blockheader">                                    
                                    <h2 class="t"><font size="1" class="rnut-postcontent">มุมบริการ</font></h2>
                                </div>
                            ...
                            <!--    
                                <div class="rnut-box-body rnut-vmenublock-body">
                                            ...
                                            <ul class="rnut-vmenu">
                                    <li>
                                            <a href="./chk_yuem_status">ตรวจสอบ:สิทธิการยืมเงิน</a>
                                    </li>
                                    <li>
                                            <hr>
                                    </li>	
