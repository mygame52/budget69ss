...
<div class="rnut-layout-wrapper">
                <div class="rnut-content-layout">
                    <div class="rnut-content-layout-row">
						...
						<h2 class="rnut-postheader" style="text-align: center;">ล้างเงินยืม : <?echo $full_name?></h2>
...
<br>
		<TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
		  <tr>
			<td colspan="5" style="text-align:left;vertical-align:middle"><H3>รายการค้างเงินยืม<?php echo "&nbsp;:&nbsp;".$full_name;?></H3></td>
		  </tr>	
		  <tr bgcolor="#CCFFFF">
	...
	<?php
				$a=0;
				$psql="SELECT * FROM person_yuem where amp = $sele_amp and chk_status='1' order by id_yuem";
				...
				<?php
					...
					echo "  <td align='center' width='15%' style='text-align:center;vertical-align:middle'><a href='#'><img src='image/status7.png' width='70%' border='0' alt='ล้างเงินยืม'></a></td>  ";
					echo "  <td align='center' width='20%' style='text-align:center;vertical-align:middle'>$citizenid_</td>  ";
					echo "  <td align='left' width='40%' style='text-align:left;vertical-align:middle'>&nbsp;&nbsp;&nbsp;&nbsp;$person_</td>  ";
					if($chk_status_=="1")
					{$mes_chk = "ค้างเงินยืม";}
					else
					{$mes_chk = "-";}
