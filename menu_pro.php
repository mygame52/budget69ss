...
$show_item_by_status_report = false;
...
if ($user_ == "admin" || $user_ == "ANONGNART" || $user_ == "pakkawadee" || $user_ == "pongkrit" || $user_ == "hamemawan" || $user_ == "pawaret") {
    ...
    $show_item_by_status_report = true;
}
?>
            ...
            <ul class="rnut-hmenu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        ?>
                        <?php
                        if ($show_item_by_status_report) {
                            echo "<li>";
                            echo "<a href='./item_by_status_report.php'><img src='image/icon/blog.png' width='16' height='16' border='0' alt='' />&nbsp;&nbsp;รายงานรายการจ่ายทั้งหมดตามสถานะ</a>";
                            echo "</li>";
                        }
                        ?>
                        <li>
                    ...
                    ?>
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="./year_budget_stop_all.php" /><img src="image/service-on.png" width="16" height="16" border="0" alt="" />&nbsp;เปิด-การตั้งเบิก งปม. -&nbsp;<b>
                                            <font color="000000">ทั้งหมด</font>
                                        </b></a>
                                    </li>
                                    <li>
                                        <a href="./year_budget_run_all.php" /><img src="image/service-off.png" width="16" height="16" border="0" alt="" />&nbsp; ปิด-การตั้งเบิก งปม. -&nbsp;<b>
                                            <font color="000000">ทั้งหมด</font>
                                        </b></a>
                                    </li>
                                    <li>
                                        <a href="./year_budget_stop.php" /><img src="image/icon/block.png" width="16" height="16" border="0" alt="" />&nbsp;การตั้งเบิก งปม. -&nbsp;<b>
                                            <font color="000000">รายอำเภอ</font>
                                        </b></a>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="rnut-layout-cell rnut-sidebar1">
                    <div class="rnut-block clearfix">
                        <div class="rnut-blockheader">
                            <h2 class="t">
                                <font size="4">มุมบริการ</font>
                            </h2>
                        </div>
                        <div class="rnut-postcontent">
                            <font size="2">: สกร.จังหวัด</font>
                            <ul class="rnut-vmenu">
                                <li>
