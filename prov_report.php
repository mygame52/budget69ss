                        ...
                        <div class="rnut-box rnut-post">
                            <div class="rnut-box-body rnut-post-body">
                                <div class="rnut-post-inner rnut-article">
                                    <h2 class="rnut-postheader" style="text-align: center;">รายงานสถานะการเบิกจ่ายงบประมาณ</h2>
                                    ...
                                    <div align="center">
                                        <table width="70%" border="0" cellspacing="0" cellpadding="7" align="center">
                                            <tr>
                                                <td width="20%" scope="col"><div align="right">เลือกหน่วยงาน </div></td>
                                                ...
                                                <td width="25%"><div align="left"><font size="3" color="990000"><?php
                                                            if ($F1 == "Yes") {
                                            ...
                                            if ($F1 == "Yes") {   ////////////// if ชุดที่ 1  เลือกงานโครงการ
                                                ...
                                                <td>
                                                    ...
                                                    <form id="form2 	" name="form2" method="post" action="prov_report1.php"> 
                                                        <label>
