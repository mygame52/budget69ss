<?php session_start();
	...
	if (empty($search)) {
				$query_item = "SELECT * FROM item where c_khong like '$codework' ORDER BY id_item DESC";
			}else{
				$query_item = "SELECT * FROM item where ((c_khong like '$codework') and (item like '%$search%')) ORDER BY id_item DESC";
	}
...
<div class="rnut-nav-outer">
	<ul class="rnut-hmenu">
		<li>
			<a href="amp_report_classification_work.php" class="active">Back</a>
		</li>	
...
<div class="rnut-layout-wrapper">
                <div class="rnut-content-layout">
                    <div class="rnut-content-layout-row">
						...
						<h2 class="rnut-postheader" style="text-align: center;">รายงานการเบิกจ่ายงบประมาณ :&nbsp;<?echo "<FONT SIZE='3' COLOR='#3333CC'><B>$cod_work :&nbsp;$aa $full_name</B></FONT>";?></h2>
