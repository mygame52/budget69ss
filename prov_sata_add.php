...
<div class="rnut-layout-wrapper">
                <div class="rnut-content-layout">
                    <div class="rnut-content-layout-row">
						...
						<h2 class="rnut-postheader" style="text-align: center;">จัดการข้อมูล:รายการค่าสาธารณูปโภค</h2>
...
<!-- start การแก้ไขข้อมูล -->
		...
		<TABLE width="100%" border="1" cellspacing="0" cellpadding="5" align="center">
		  <tr>
			<td colspan="3" style="text-align:left;vertical-align:middle"><H3>รายการค่าสาธารณูปโภค</H3></td>
			<td align="center"><a href="prov_sata_add1.php"><IMG SRC='./image/users--plus.png' WIDTH='24' HEIGHT='24' BORDER='0' ALT='เพิ่ม' onClick='return Conf(this)'></a>
			</td>
		  </tr>	
		  <tr bgcolor="#E3E1B7">
		    <th scope="col">id</th>
		    <th scope="col">รายการค่าสาธารณูปโภค</th>
	...
	<?php
				$a=0;
//				$sele_amp = "00";
				$psql="SELECT * FROM public_utility order by idu";
				...
				if ($a%2==0){
					...
					echo "  <td align='center' width='50%' style='text-align:left;vertical-align:middle'>$name_pub_</td>  ";
					echo "  <td align='left' width='20%' style='text-align:left;vertical-align:middle'>&nbsp;&nbsp;&nbsp;&nbsp;$name_shot_</td>  ";
					echo "  <td align='center' width='10%' style='text-align:center;vertical-align:middle'><a href='prov_sata_delete.php?idu_=$idu_'><IMG SRC='./image/cross.png' WIDTH='16' HEIGHT='16' BORDER='0' ALT='ลบ' onClick='return Conf(this)'></a></td>  ";
